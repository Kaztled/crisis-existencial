            ...
            if($("#fileProductos").get(0).files.length == 0){
                ...
                $.ajax({
                    ...
                    success:function(respuesta){
                        ...
                        if(respuesta['totalCategorias'] > 0 && respuesta['totalProductos'] > 0 && respuesta['totalProveedores'] > 0){
                        
                            Swal.fire({
                                position:'center',
                                icon:'success',
                                title: 'Se registraron ' + respuesta['totalCategorias'] + ' categorías, ' + respuesta['totalProductos'] + ' productos y ' + respuesta['totalProveedores'] + ' proveedores correctamente!',
                                showConfirmButton: false,
                                timer: 2500
                            })
                            ...
                            Swal.fire({
                                position:'center',
                                icon:'error',
                                title: 'Se presento un error al momento de realizar el registro de categorías, productos y/o proveedores!',
                                showConfirmButton: false,
                                timer: 2500
                            })
